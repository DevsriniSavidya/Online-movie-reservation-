    ...
    <Container maxWidth="lg">
      <Switch>
        ...
        <Route
          path="/displayMovies"
          exact
          component={isLogged ? DisplayMovie : NotFound}
        />
        <Route
          path="/addMovie"
          exact
          component={isAdmin ? AddMovie : NotFound}
        />
        <Route
          path="/movieDetails"
          exact
          component={isLogged ? MovieDetails : NotFound}
        />
        <Route
          path="/updateMovie"
          exact
          component={isAdmin ? UpdateMovie : NotFound}
        />
        <Route path="/homeMovie" exact component={HomeDisplayMovies} />
        ...
        <Route
          path="/addPayment"
          component={isLogged ? AddPayment : NotFound}
        />
        <Route
          path="/reservation"
          component={isLogged ? DisplayReservation : NotFound}
        />
